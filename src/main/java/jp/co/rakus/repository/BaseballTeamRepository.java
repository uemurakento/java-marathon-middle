...
public class BaseballTeamRepository {
	...
	public static final RowMapper<BaseballTeam> BASEBALL_TEAM_ROWMAPPER = (rs,i) -> {
		BaseballTeam baseballTeam = new BaseballTeam(rs.getInt("id"),rs.getString("team_name"),rs.getString("headquarters"),rs.getString("inauguration"),rs.getString("history"));
		return baseballTeam;
	};
